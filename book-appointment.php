    ...
    <div class="uk-container">
        <?php if ($success_message): ?>
            ...
            <div class="uk-text-center uk-margin-large uk-padding-large booking-confirmation">
                ...
                <h2 class="uk-heading-medium uk-margin-remove"><?php echo $success_message; ?></h2>
                <p class="uk-text-lead uk-margin-large-top">Check your email for confirmation details.</p>
                <div class="uk-margin-large-top">
                    <a href="my-appointments.php" class="uk-button uk-button-primary uk-button-large uk-margin-right">
                        <span uk-icon="icon: calendar"></span> View My Appointments
                    </a>
                    <a href="/find-doctors.php" class="uk-button uk-button-default uk-button-large">
